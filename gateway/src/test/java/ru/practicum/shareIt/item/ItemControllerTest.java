...
class ItemControllerTest {
    ...
    @Test
    void search_shouldHandleEmptyResult() throws Exception {
    ...
    @Test
    void addComment_shouldFailWithoutHeader() throws Exception {
    ...
    @Test
    void addComment_shouldFailWithInvalidBody() throws Exception {

        Long userId = 1L;
        Long itemId = 2L;

        CommentCreateDto dto = new CommentCreateDto(""); // invalid
